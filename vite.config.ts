  ...
  const config: UserConfig = {
    ...
    resolve: {
      alias: {
        ...
        string_decoder: 'rollup-plugin-node-polyfills/polyfills/readable-stream/string-decoder',
        'string-decoder': 'rollup-plugin-node-polyfills/polyfills/readable-stream/string-decoder',
