...
const SocialLinkItem: React.FC<SocialLinkItemProps> = ({ platformType, url }) => {
  ...
  if (platformType === 'discord') {
    return (
      <button
        ...
        className="hover:opacity-70 transition-opacity bg-secondary/30 p-6 rounded-full flex items-center justify-center group relative"
  ...
  return (
    <a 
      ...
      className="hover:opacity-70 transition-opacity bg-secondary/30 p-6 rounded-full flex items-center justify-center"
