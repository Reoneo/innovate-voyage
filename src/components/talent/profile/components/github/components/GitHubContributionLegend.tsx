...
export default function GitHubContributionLegend({ isVerified = false }: GitHubContributionLegendProps) {
  return (
    <div className="legend-container mt-0 mb-0 flex flex-col items-center justify-between text-xs text-white">
      ...
      <div className="mt-1 text-center">
        {isVerified ? (
          ...
          <span className="text-xs text-white/70">Unverified on-chain data</span>
        )}
      </div>
    </div>
  );
