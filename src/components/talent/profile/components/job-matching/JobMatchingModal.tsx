...
import { Briefcase, MapPin, Clock, ExternalLink, Building, ArrowLeft } from 'lucide-react';
...
const JobMatchingModal: React.FC<JobMatchingModalProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-screen h-screen max-w-none max-h-none m-0 p-0 bg-white border-0 shadow-2xl rounded-none overflow-hidden">
        <div className="flex flex-col h-full">
          <DialogHeader className="relative border-b border-gray-100 p-6 flex-shrink-0">
