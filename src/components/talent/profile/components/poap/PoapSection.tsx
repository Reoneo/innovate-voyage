        ...
        <div className="relative w-[400px] h-[400px] mx-auto">
          {isLoading ? <Skeleton className="h-[360px] w-[360px] rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" /> : poaps.length > 0 ? <div className="relative flex items-center justify-center h-full">
            ...
            objectFit: 'contain'
              ...
              <button onClick={() => currentPoapIndex > 0 && setCurrentPoapIndex(prev => prev - 1)} disabled={currentPoapIndex === 0} className="absolute left-0 z-30 p-1 rounded-full bg-white/80 shadow-sm -translate-x-1/2 py-[10px]">
