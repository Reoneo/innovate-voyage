...
const TallyInsightsSection: React.FC<TallyInsightsSectionProps> = ({ walletAddress }) => {
    ...
    <>
      <Card className="bg-white/90 shadow-md rounded-lg p-4 mb-6 backdrop-blur-sm">
        <div className="mb-4 flex justify-between items-center">
          <div>
            <h2 className="text-xl font-bold text-gray-800">Governance</h2>
            <p className="text-sm text-gray-500">On-chain voting activity</p>
          </div>
          <img 
