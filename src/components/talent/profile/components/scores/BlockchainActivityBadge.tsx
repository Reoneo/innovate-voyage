    ...
    <div onClick={handleClick} className="cursor-pointer">
      <div className="flex flex-col items-center gap-2 p-4 bg-white rounded-2xl shadow-sm border border-gray-200 px-0 py-[10px] my-[2px] hover:shadow-md transition-shadow duration-200 min-h-[120px] w-full">
        ...
        <div className="text-center w-full">
          ...
          <p className="text-gray-500 py-0 font-normal text-base">Transactions</p>
        </div>
        {hasEmptyData && (
          <button
            onClick={e => {
            ...
            className="flex-shrink-0 px-2 py-1 mt-2 bg-gray-200 rounded-md hover:bg-gray-300 text-xs text-gray-600 transition-colors"
            title="Refresh data"
          >
