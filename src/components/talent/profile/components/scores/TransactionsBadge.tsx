        ...
        <div className="flex flex-col items-center gap-3 p-6 bg-white rounded-2xl h-full shadow-lg border border-gray-200 px-0 py-[26px]">
          <div className="text-center space-y-2">
            ...
            <div className="relative">
              ...
              {nftCount !== null && nftCount > 0 && <Badge variant="destructive" className="absolute -top-2 -right-2 min-w-6 h-6 flex items-center justify-center rounded-full text-sm font-bold py-0 px-[2px] mx-[29px] my-[9px]">
