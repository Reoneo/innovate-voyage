...
export const mainnetProvider = new ethers.JsonRpcProvider(
  process.env.VITE_ETHEREUM_RPC_URL || "https://mainnet.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161"
); 

export const optimismProvider = new ethers.JsonRpcProvider(
  process.env.VITE_OPTIMISM_RPC_URL || "https://optimism-mainnet.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161"
); 
