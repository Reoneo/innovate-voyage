...
import AnimatedProfileBackground from '@/components/talent/profile/components/AnimatedProfileBackground';
...
const TalentProfile = () => {
  ...
  return (
    <>
      ...
      <AnimatedProfileBackground avatarUrl={passport?.avatar_url}>
